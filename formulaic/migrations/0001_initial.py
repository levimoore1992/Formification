...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        validators=[formulaic.validators.validate_mixed_content]
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operator",
                    models.CharField(
                        choices=[("and", "And"), ("or", "Or")], max_length=3
                    ),
                ),
                ...
                (
                    "form",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="formulaic.Form"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "form",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="formulaic.Form"
                    ),
                ),
            ],
        ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("change-option-group", "Change Option Group"),
                        ],
                        max_length=50,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="list",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="formulaic.OptionList"
            ),
        ),
        migrations.AddField(
            model_name="form",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value_option",
                    models.CharField(
                        choices=[("is", "is"), ("is_not", "is not")], max_length=15
                    ),
                ),
                (
                    "affected_field",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="affecting_conditions",
                        to="formulaic.Field",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="watching_conditions",
                        to="formulaic.Field",
                    ),
                ),
            ],
