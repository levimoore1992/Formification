// Thin REST client for the Formulaic DRF API.
//
// Endpoints are the DRF SimpleRouter viewsets from formulaic/urls.py:
//   /formulaic/api/forms/, fields/, textfields/, choicefields/,
