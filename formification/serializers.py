            ...
            if condition.get("id"):
                ...
                for condition_obj in condition_objs:
                    if condition.get("id") == condition_obj.id:
                        ...
                        condition_obj.field = condition.get(
            ...
            if result.get("id"):
                ...
                for result_obj in result_objs:
                    if result.get("id") == result_obj.id:
                        ...
                        result_obj.field = result.get("field", result_obj.field)
...
class CustomDateTimeField(serializers.DateTimeField):
    def to_representation(self, obj):
        obj_aware = (
            obj if obj.utcoffset() is not None else obj.replace(tzinfo=get_localzone())
        )
