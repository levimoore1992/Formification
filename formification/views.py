...
from formification import models, utils, serializers, settings
from formification.csv_export import export_submissions_to_file
...
@permission_required("formification.change_submission")
@never_cache
def download_submissions(request):
    ...
    full_path = "{}/{}".format(settings.FORMIFICATION_EXPORT_STORAGE_LOCATION, filename)
