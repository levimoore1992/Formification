...
// formification/models.py (TextField.SUBTYPES, ChoiceField.SUBTYPES, etc.).
...
export const useFieldsStore = defineStore('fields', {
  ...
  actions: {
    ...
    // POST to the specific endpoint: /formification/api/{modelClass}s/
    ...
    async create(formId, { modelClass, subtype, optionListId }) {
      ...
      try {
        ...
        const payload = {
          ...
          data_name: `field_${identifier.replaceAll('-', '_')}`,
        ...
        if (modelClass === 'choicefield') {
          payload.option_list = scope_id(optionListId)
          payload.default_option = null
          payload.default_options = null
        }
