...
const DJANGO_DEV = process.env.FORMIFICATION_DJANGO_DEV || 'http://127.0.0.1:8000'

export default defineConfig({
  plugins: [vue()],

  // Relative base: the built index.html is served from
  // /static/admin/formification/vue-formification/dist/ by Django, and every asset
