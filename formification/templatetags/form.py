...
def formification_field_classes(widget):
    classes = []
...
register.filter("formification_extra_attributes", add_attributes_to_field)
register.filter("formification_extra_widget_classes", add_classes_to_field)
register.filter("formification_field_classes", formification_field_classes)
